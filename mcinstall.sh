...
useradd -m -d /home/mc -s /bin/bash -c "mc server" -U mc #create a seggregated user
...
cd /home/mc/serverfiles # navigate top dir
curl --output spigot.jar https://cdn.getbukkit.org/spigot/spigot-1.16.5.jar # Download spigot
